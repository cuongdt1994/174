			...
			try
			{
				...
				if( pstorage->find( key, os_value1, txn ) )
				{
					...
					if (user1.consume_reward.size())
					{
						...
						try
						{
							Marshal::OctetsStream os_reward(user1.consume_reward);
							os_reward >> reward1;
						}
						catch( ... ) // is db <= 152
						{
							...
							reward1.consume_points	= r152.consume_points	;
							reward1.bonus_reward	= r152.bonus_reward		;
							reward1.rewardlist		= r152.rewardlist		;
							reward1.cash_vip_info.clear()					;
						}
					...
					if (user2.consume_reward.size())
					{
						...
						try
						{
							Marshal::OctetsStream os_reward(user2.consume_reward);
							os_reward >> reward2;
						}
						catch( ... ) // is db <= 152
						{
							...
							reward2.consume_points	= r152.consume_points	;
							reward2.bonus_reward	= r152.bonus_reward		;
							reward2.rewardlist		= r152.rewardlist		;
							reward2.cash_vip_info.clear()					;
						}
