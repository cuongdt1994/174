		...
		void ReadUser(int userid, const User & user)
		{
			...
			if(user.consume_reward.size())
			{
				...
				catch( ... ) // is db <= 152
				{
					...
					reward_store.consume_points	= r152.consume_points	;
					reward_store.bonus_reward	= r152.bonus_reward		;
					reward_store.rewardlist		= r152.rewardlist		;
					reward_store.cash_vip_info.clear()					;
				}
