...
namespace GNET
{
	...
	unsigned int GetDataRoleId(unsigned int cls)
	{
		...
		*/
		switch( cls )
		{
			case 0:		return 16; //§Ó§à§Ú§ß
			case 1:		return 19; //§Þ§Ñ§Ô
			case 2:		return 20; //§ê§Ñ§Þ§Ñ§ß
			case 3:		return 23; //§Õ§â§å§Ú§Õ
			case 4:		return 24; //§à§Ò§à§â§à§ä§Ö§ß§î
			case 5:		return 27; //§å§Ò§Ú§Û§è§Ñ
			case 6:		return 28; //§Ý§å§é§ß§Ú§Ü
			case 7:		return 31; //§Ø§â§Ö§è
			case 8:		return 18; //§ã§ä§â§Ñ§Ø
			case 9:		return 17; //§Þ§Ú§ã§ä§Ú§Ü
			case 10:    return 21; //§á§â§Ú§Ù§â§Ñ§Ü
			case 11:    return 22; //§Ø§ß§Ö§è	
			case 12:    return 25; //§ã§ä§â§Ö§Ý§à§Ü
			case 13:    return 26; //§á§Ñ§Ý§Ñ§Õ§Ú§ß
			case 14:    return 29; //§Þ§Ñ§Ü§Ñ§Ü§Ñ
			default:
	...
	bool GameDBManager::SaveUserDefault( )
	{
		try
		{
			...
			try
			{
				...
				rolelist.AddRole( 25 % MAX_ROLE_COUNT );
				rolelist.AddRole( 26 % MAX_ROLE_COUNT );
				rolelist.AddRole( 29 % MAX_ROLE_COUNT );
	...
	void GRoleBaseToDetail( const GRoleBase & base, GRoleDetail & detail )
	{
		...
		//detail.hd_custom_data = base.hd_custom_data;
	...
	void GRoleDetailToBase( const GRoleDetail & detail, GRoleBase & base )
	{
		...
		//base.hd_custom_data = detail.hd_custom_data;
	}
