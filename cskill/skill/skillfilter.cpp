...
DEFINE_SUBSTANCE(filter_Bleeding2,filter,CLASS_BLEEDING2);
...
DEFINE_SUBSTANCE(filter_Debithurt7,filter,CLASS_DEBITHURT7);
...
DEFINE_SUBSTANCE(filter_Wolf,filter,CLASS_WOLF);
