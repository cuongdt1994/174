...
enum
{
	GM_TYPE_INVALID = -1,
	GM_TYPE_SERVER,				//id �Ƿ�����
	GM_TYPE_BROADCAST,			//id �����õģ�����һ���㲥��Ϣ,�����߾����յ��ķ���������
	GM_TYPE_PLAYER,				//id ���û�id
	GM_TYPE_TEAM,				//id �����Ŀ��
	GM_TYPE_NPC,				//id ��npc
	GM_TYPE_ACTIVE,				//id ���ã���������󣬼�NPC��player
	GM_TYPE_MATTER,				//id ����Ʒ
	GM_TYPE_PET,				//id �ǳ�����߸���NPC,��ID����ҵ��ʺ�ID�ϼ������
	GM_TYPE_OBJECT,				//id ��������� ,���罻�׶���
	GM_TYPE_SELF,				//id ���Լ������Ժ��Ժ����ID
	GM_TYPE_MINE_SPAWNER,			//id ��MATTER ���������spawner
	GM_TYPE_MAFIA,				//id �ǰ���Ŀ��
};
#define 	PET_MASK 	0x20000000	//bit 29��ʾ�Ƿ�Ϊ����
...
struct XID_HashFunc
{
	uint32_t operator()(const XID & id) const
	{
